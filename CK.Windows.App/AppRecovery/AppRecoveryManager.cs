...
namespace CK.Windows.App
{
    ...
    public static class AppRecoveryManager
    {
        ...
        {
            get { return _registeredExceptions != null ? _isOSRecoveryAvailable : OSVersionInfo.OSLevel >= OSVersionInfo.SimpleOSLevel.WindowsVista; }
        }
        ...
        public static bool Initialize( string crashLogDirectory, string crashUploadUrl )
        {
            ...
            try
            {
                ...
                if( OSVersionInfo.OSLevel < OSVersionInfo.SimpleOSLevel.WindowsVista ) return _isOSRecoveryAvailable = false;

...
namespace CK.Plugin
{
	public interface IPluginDiscoverer
	{
        ...
        /// </summary>
        ICKReadOnlyCollection<IAssemblyInfo> AllAssemblies { get; }
        ...
        /// </summary>
        ICKReadOnlyCollection<IAssemblyInfo> PluginOrServiceAssemblies { get; }

        /// <summary>
        /// Contains all the <see cref="IPluginInfo"/> that have been succesfully discovered with the best
        /// available version.
        /// </summary>
        ICKReadOnlyCollection<IPluginInfo> Plugins { get; }

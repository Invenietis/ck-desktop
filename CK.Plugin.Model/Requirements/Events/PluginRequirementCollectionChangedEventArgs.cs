...
namespace CK.Plugin
{
    ...
    public class PluginRequirementCollectionChangedEventArgs : EventArgs
    {
        ...
        public PluginRequirementCollectionChangedEventArgs( IPluginRequirementCollection c, NotifyCollectionChangedAction action, Guid pluginId, RunningRequirement requirement )
        {
            Collection = c;
            Action = action;
            PluginId = pluginId;
